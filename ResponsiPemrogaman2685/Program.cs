...
namespace ResponsiPemrogaman2685
{
    class Program
    {
        static void Main(string[] args)
        {
            Karyawan karyawan = new Karyawan(1 ,19112685, "Deny Agung P", 3000000);
            Karyawan karyawan2 = new Karyawan(2 ,19112685, "Deny Prasetyo", 2000000);
